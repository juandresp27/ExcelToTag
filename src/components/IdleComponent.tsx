...
export function IdleComponent () {
    return (
        ...
        <main className='grid grid-cols-1 md:grid-cols-2 items-center justify-center h-full'>
            ...
            <h2 className='mt-4 md:mt-6 font-Synonym text-lg font-medium  '><span className='text-[#c561ff]'>Import</span> your Excel, select sheets and rows, <span className='text-[#c561ff]'>view</span> and adjust the preview, and <span className='text-[#c561ff]'>print</span> your custom labels.</h2>
            </section>
