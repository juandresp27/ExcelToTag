...
export default function ThemeSwitcher() {
  ...
  const handleChangeTheme = (event: BaseSyntheticEvent) => {
  ...
  return (
      ...
      <label id="theme-toggle-button">
        <input type="checkbox" id="toggle" onChange={handleChangeTheme} defaultChecked={theme==="dark"}/>
